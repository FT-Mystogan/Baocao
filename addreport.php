...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $money = $_POST['money'];
        $thang = $_POST['month'];
        $sql = "INSERT INTO baocao(fullname,address,bks,content,money,thang) values( '$fullname','$address','$bks','$content','$money','$thang') ";
        execute($sql);
        ...
        <div class="table-all table-responsive p-3">
            ...
            <form action="" method="POST">
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-success " style="width: 120px;" name="submit">Thêm</button>
                </div>
            </form>
        </div>
    </div>
